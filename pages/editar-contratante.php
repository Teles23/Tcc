                    ...
                    <form action="" method="post">
                        <div class="row g-2">
                            <div class="form-floating ">
                                ...
                                <label for="floatingInput" class="label">Nome da Empresa</label>
                            </div>
                            <div class="col-md">
                                <div class="form-floating ">
                                    <input type="tel" class="form-control" id="floatingInput" placeholder="Usuario">
                                    <label for="floatingInput" class="label">CPF/CNPJ</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-floating ">
                                    ...
                                    <label for="floatingInput" class="label">Tipo</label>
                                </div>
                            </div>
                            <div class="row g-1">
                                <div class="col-md">
                                    <div class="form-floating ">
                                        ...
                                        <label for="floatingInput" class="label">Categoria</label>
                                    </div>
                                </div>
                                <div class="col-md">
                                    <div class="form-floating ">
