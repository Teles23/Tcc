<header>
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark fixed-top">
        <div class="container-fluid container">
            ...
            <a href="../index.php" target="_self"> <img src="../assets/img/nome.png" alt="" width="80px" height="40px"></a>
            <button class="navbar-toggler  dropdown-toggle dropdown-toggle-split" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav nav-mobile">
                    <li class="nav-item dropdown flex-container nav-perfil">
                        <a target="_self" class="nav-link dropdown-toggle navbar-brand" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="text-transform: capitalize;"> <img src="../assets/img/teste.jpg" alt="" width="40" height="40" class="perfil-nav"></a>
